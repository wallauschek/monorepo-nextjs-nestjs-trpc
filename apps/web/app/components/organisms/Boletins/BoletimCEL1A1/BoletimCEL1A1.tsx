        ...
        <>
          ...
          <div style={{ maxHeight: '500px', overflow: 'auto' }}>
            <table className={'boletim table table-auto w-full  divide-y divide-gray-200 border border-gray-100 overflow-x-auto overflow-y-auto text-xs text-gray-600'}>
              <colgroup>
                <col span={1} />
                <col span={4} className="bg-blue-100"/>
                <col span={4} className="bg-green-100"/>
                <col span={4} className="bg-red-100"/>
                <col span={1} />
              </colgroup>
              <thead className="bg-gray-50">
                <tr>
                  <th className="p-2 border border-gray-100 min-w-[120px]" rowSpan={2} ></th>
                  <th className="p-2 border border-gray-100" colSpan={4}>Trimestre 1</th>
                  <th className="p-2 border border-gray-100" colSpan={4}>Trimestre 2</th>

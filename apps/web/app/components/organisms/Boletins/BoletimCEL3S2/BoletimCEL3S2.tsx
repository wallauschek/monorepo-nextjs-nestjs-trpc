    ...
    <div className="overflow-x-auto border-2 border-solid border-white ">
      { studentSelected && dados?.notas && dados.notas.length > 0 ? (
        <>
          ...
          <div style={{ maxHeight: '500px', overflow: 'auto' }}>
            <table className={'boletim table table-auto w-full  divide-y divide-gray-200 border border-gray-100 overflow-x-auto overflow-y-auto text-xs text-gray-600'}>
              <colgroup>
                ...
                <col span={7} className="bg-red-100"/>
                <col span={1} />
              </colgroup>
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="p-2 border border-gray-100" colSpan={7}>Trimestre 3</th>
                ...
                <tr>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">S1</th>
                  <th className="p-2 border border-gray-100 min-w-[60px]">S2</th>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">S3</th>
                  <th className="p-2 border border-gray-100 min-w-[60px]">S4</th>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">S5</th>
                  <th className="p-2 border border-gray-100 min-w-[60px]">S6</th>
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {dados.notas.length > 0 && dados.notas.map((item: any, idx: number) => (
                  <tr key={idx} className={idx % 2 === 0 ? '' : 'bg-gray-50'}>
                    ...
                    <td className="p-2 text-center border border-gray-100">{item.SIM1T1 || '-'}</td>
                    <td className="p-2 text-center border border-gray-100">{item.SIM2T1 || '-'}</td>
                    ...
                    <td className="p-2 text-center border border-gray-100">{item.SIM1T2 || '-'}</td>
                    <td className="p-2 text-center border border-gray-100">{item.SIM2T2 || '-'}</td>
                    ...
                    <td className="p-2 text-center border border-gray-100">{item.SIM1T3 || '-'}</td>
                    <td className="p-2 text-center border border-gray-100">{item.SIM2T3 || '-'}</td>
          ...
          <div className={'pt-4'}>
              <table className={'table table-auto w-full  divide-y divide-gray-200 border border-gray-100 overflow-x-auto overflow-y-auto text-xs text-gray-600'}>
                  <thead className="bg-gray-50">
                    <tr>

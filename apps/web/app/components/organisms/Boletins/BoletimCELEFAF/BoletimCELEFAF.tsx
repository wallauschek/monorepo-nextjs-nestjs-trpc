...
interface NotasProps {
  notas: any; // Substitua "any" pelo tipo correto se você tiver uma interface ou tipo para "notas"
}

const BoletimCELEFAF = () => {
        ...
        <>
          ...
          <div style={{ maxHeight: '500px', overflow: 'auto' }}>
            <table className={'boletim table table-auto w-full  divide-y divide-gray-200 border border-gray-100 overflow-x-auto overflow-y-auto text-xs text-gray-600'}>
              <colgroup>
                <col span={1} />
                <col span={6} className="bg-blue-100"/>
                <col span={6} className="bg-green-100"/>
              ...
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="p-2 border border-gray-100" colSpan={6}>Trimestre 1</th>
                  <th className="p-2 border border-gray-100" colSpan={6}>Trimestre 2</th>
                ...
                <tr>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">AAS1</th>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">AAS2</th>
                  ...
                  <th className="p-2 border border-gray-100 min-w-[60px]">AAS3</th>
